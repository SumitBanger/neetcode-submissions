class Solution:
    def uniquePaths(self, m: int, n: int) -> int:
        ...
        # Calculate combinations using Python's built-in math function
        ...
        #             continue
        #         if r+1 < m:
        #             dp_r[c] += dp_r1[c] # Bottom Row same Column (Below Cell)
        #         if c+1 < n:
        #             dp_r[c] += dp_r[c+1] # Same Row next Column (Right Cell)
        #     dp_r1 = dp_r
        # return dp_r1[0]
